  ...
  return (
    <BaseScrollArea.Viewport
      className={cn(
        ...
        'focus-visible:outline focus-visible:outline-on-surface-variant focus-visible:outline-offset-2',
        gradientScrollFade &&
          cn(
...
function ScrollAreaCorner({ className, ...props }: BaseScrollArea.Corner.Props) {
  return (
...
function ScrollAreaContent({ className, ...props }: BaseScrollArea.Content.Props) {
  return (
  ...
  return (
    <BaseScrollArea.Scrollbar
      className={cn(
        ...
        'absolute z-20 p-0.5',
        orientation === 'vertical' && 'right-0 top-0 bottom-0 w-2 border-l border-l-transparent',
    ...
    >
      <BaseScrollArea.Thumb
        className="bg-on-surface-variant relative flex-1 rounded-full"
...
function ScrollArea({
  ...
  return (
    <BaseScrollArea.Root
      ...
      {...props}
    >
      <ScrollAreaViewport className="flex-1 min-h-0" gradientScrollFade={gradientScrollFade}>

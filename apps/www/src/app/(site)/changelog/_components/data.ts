export const changelogs = [
  {
    content: [
      'Generate a full theme, check its contrast, and export it without leaving your terminal.',
      'Coding agents can drive tonex directly — it ships as a skill they call to build and verify palettes.',
    ],
    date: 'Jun 2026',
    latest: true,

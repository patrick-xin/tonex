    ...
    >
      <DialogPortal>
        ...
        <DialogViewport className="z-12 grid place-items-end p-4 sm:place-items-center">
          <DialogPopup className="surface-dialog relative grid w-full max-w-sm gap-4 rounded-lg p-4 shadow-lg animate-fade-zoom sm:p-6">
            {!touring && (
              <>
                <DialogHeader>
              ...
              <>
                <DialogHeader>
                  <DialogTitle className="flex items-center justify-between">
                    {currentStep.title}
                    <span className="ml-auto flex items-center text-xs text-on-surface-variant">
                ...
                <DialogFooter className="justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    {learnMore !== null && (
                      <Button variant="ghost" size="sm" onClick={() => openLearnMore(learnMore)}>
                        Learn more
                      </Button>
                    )}
                  </div>

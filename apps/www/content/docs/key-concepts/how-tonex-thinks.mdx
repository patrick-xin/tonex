...
That is the core idea: the semantic source is the contract; the target mapping is the last mile. See [Design tokens](/docs/key-concepts/design-tokens) and [Targets & formats](/docs/cli/targets-formats) for how that contract travels.
